...
if (Device.isUsingDarkAppearance()){
  const backColor = new Color('1D1C21')
  const fillColor = new Color('FC4C02')
  const textColor = new Color('EDEDED')
  const textColor1 = new Color('FC4C02')
  const textColor2 = new Color('5B5A5E')
  const mapColor = new Color('000000')
}
*/
const backColor = new Color('FFFFFF')
const fillColor = new Color('FC4C02')
const textColor = new Color('1D1C21')
const textColor1 = new Color('FC4C02')
const textColor2 = new Color('5B5A5E')
const mapColor = new Color('E6E6E6')
...
function drawActivityIcon(workout) {
    ...
    if (workout.type === workoutTypeBike) {
        ...
        // Draw wheels
        activityIcon.setFillColor(fillColor);
        activityIcon.setStrokeColor(fillColor);
        ...
        for (let i = 0; i < frameLines.length; i++) {
            ...
            drawLine(activityIcon, point1, point2, 2, fillColor);
        }
    } else {
...
function graph(input_array) {
    ...
    for (let i = (dataPointsToShow - 1), j = 0; i >= 0; i--, j++) {
        ...
        if (i > 0) {
            ...
            drawLine(drawContext, point1, point2, lineWeight, mapColor)
        }
    }
}
...
if (widgetInput.length !== 40) {
    ...
    let map_data = createMapData(newest_activity)
    graph(map_data);
    ...
    caloriesText.textColor = textColor;
    ...
    distanceText.textColor = textColor;
    ...
    elevationGainText.textColor = textColor;
    ...
    kudosText.textColor = textColor1;
